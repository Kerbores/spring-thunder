...
public class Pager<T> {
    ...
    /**
     * @param count the count to set 记录条数,将根据记录条数生成数据页数,用count()从数据库查询
     */
    ...
    /**
     * @param entities the entities to set 数据列表,根据条件从数据库分页查出
     */
    ...
    /**
     * @param maxLength the maxLength to set 分页条的最大长度
    ...
    /**
     * @param page the page to set 当前页码
     */
    ...
    /**
     * @param pageSize the pageSize to set 页面大小,默认15
     */
    ...
    /**
     * @param url the url to set 设置分页路径,建议绝对路径
