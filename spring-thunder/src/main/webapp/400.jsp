...
<html lang="en">
    ...
    <head>
        ...
        <link rel="shortcut icon" href="<%=basePath %>/assets/spring-thunder/images/spring-thunder.ico" /> </head>

    <body class=" page-404-3">
        <div class="page-inner">
            <img src="<%=basePath %>/assets/metronic/pages/media/pages/earth.jpg" class="img-responsive" alt=""> </div>
        <div class="container error-404">
            <h1>400</h1>
            <h2>Bad request</h2>
            <p> Actually,There is some problem with the parameters you provide. </p>
            <p>
